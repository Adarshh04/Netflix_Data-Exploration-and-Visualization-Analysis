<hr> Netflix_Data-Exploration-and-Visualization-Analysis 
...
Visualize distributions of movies, TV shows, ratings, and release years.

Identify top genres, countries, and directors.

Discover trends in content growth over time.
...
Data Exploration – Analyze structure, summary statistics, and feature distributions.

Visualization – Create plots (histograms, countplots, heatmaps, word clouds) to identify patterns.
...
2017–2020 saw major content expansion.
